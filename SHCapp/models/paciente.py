...
class Paciente(models.Model):
    ...
    id_usuario = models.ForeignKey(User, related_name="Paciente", on_delete=models.CASCADE)
    id_cuidador = models.ForeignKey(User, related_name="Paciente", on_delete=models.CASCADE)